...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__content_process__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_alpheios_inflection_tables__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_message__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__panel__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_options__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__templates_symbols_htmlf__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__templates_page_controls_htmlf__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__templates_panel_htmlf__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__templates_options_htmlf__ = __webpack_require__(13);
...
var Process = function () {
  function Process() {
    ...
    this.messagingService = new __WEBPACK_IMPORTED_MODULE_1__lib_message__["b" /* MessagingService */]();
  }
  ...
  _createClass(Process, [{
    ...
    value: function messageListener(message, sender) {
      ...
      if (!message.type) {
      ...
      } else if (message.type === __WEBPACK_IMPORTED_MODULE_1__lib_message__["a" /* Message */].types.ACTIVATE_REQUEST) {
        // Send a status response
        console.log('Activate request received. Sending a response back.');
        if (!this.isActive) {
          this.reactivate();
        }
        this.messagingService.sendResponseToBg(new __WEBPACK_IMPORTED_MODULE_1__lib_message__["c" /* StatusResponse */](this.status, message));
      } else if (message.type === __WEBPACK_IMPORTED_MODULE_1__lib_message__["a" /* Message */].types.DEACTIVATE_REQUEST) {
        // Send a status response
        ...
        this.messagingService.sendResponseToBg(new __WEBPACK_IMPORTED_MODULE_1__lib_message__["c" /* StatusResponse */](this.status, message));
      } else if (message.type === __WEBPACK_IMPORTED_MODULE_1__lib_message__["a" /* Message */].types.STATUS_REQUEST) {
        // Send a status response
        console.log('Status request received. Sending a response back.');
        this.messagingService.sendResponseToBg(new __WEBPACK_IMPORTED_MODULE_1__lib_message__["c" /* StatusResponse */](this.status, message));
      } else if (message.type === __WEBPACK_IMPORTED_MODULE_1__lib_message__["a" /* Message */].types.WORD_DATA_RESPONSE) {
        console.log('Message body is:', message.body);

        if (message.status === __WEBPACK_IMPORTED_MODULE_1__lib_message__["a" /* Message */].statuses.DATA_FOUND) {
          ...
          this.panel.open();
        } else if (message.status === __WEBPACK_IMPORTED_MODULE_1__lib_message__["a" /* Message */].statuses.NO_DATA_FOUND) {
          this.panel.clear();
        ...
        browser.runtime.sendMessage(new __WEBPACK_IMPORTED_MODULE_1__lib_message__["d" /* WordDataRequest */](language, word));
      } else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_alpheios_inflection_tables__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_uuid_v1__ = __webpack_require__(4);
...
class WordDataRequest extends RequestMessage {
  constructor (language, word) {
    ...
    this.body = new __WEBPACK_IMPORTED_MODULE_0_alpheios_inflection_tables__["b" /* SelectedWord */](language, word)
  }
}
